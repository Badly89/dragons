...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'tas2580.seourls.base' => 'getTas2580_Seourls_BaseService',
            'tas2580.seourls.extensions' => 'getTas2580_Seourls_ExtensionsService',
            'tas2580.seourls.listener' => 'getTas2580_Seourls_ListenerService',
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('', 'root', '', 'dragons', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('tas2580.seourls.listener', 'tas2580\\seourls\\event\\listener');
        $instance->addSubscriberService('tas2580.seourls.extensions', 'tas2580\\seourls\\event\\extensions');
    ...
    /**
     * Gets the 'tas2580.seourls.base' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tas2580\seourls\event\base A tas2580\seourls\event\base instance.
     */
    protected function getTas2580_Seourls_BaseService()
    {
        return $this->services['tas2580.seourls.base'] = new \tas2580\seourls\event\base($this->get('auth'), $this->get('config'), './../');
    }

    /**
     * Gets the 'tas2580.seourls.extensions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tas2580\seourls\event\extensions A tas2580\seourls\event\extensions instance.
     */
    protected function getTas2580_Seourls_ExtensionsService()
    {
        return $this->services['tas2580.seourls.extensions'] = new \tas2580\seourls\event\extensions($this->get('tas2580.seourls.base'));
    }

    /**
     * Gets the 'tas2580.seourls.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tas2580\seourls\event\listener A tas2580\seourls\event\listener instance.
     */
    protected function getTas2580_Seourls_ListenerService()
    {
        return $this->services['tas2580.seourls.listener'] = new \tas2580\seourls\event\listener($this->get('tas2580.seourls.base'), $this->get('template'), $this->get('request'), $this->get('path_helper'), './../', 'php');
    }
