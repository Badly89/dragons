...
class __TwigTemplate_ed9a46163752f4099c94fe4a47d59f2b57632427c472af2e0a83806f80071722 extends Twig_Template
{
...
\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["leader"]) {
                    // line 223
                    echo "\t\t<li class=\"row";
                    if (($this->getAttribute(($context["attachrow"] ?? null), "S_ROW_COUNT", array()) % 2 == 1)) {
                        echo " bg1";
                    } else {
                        echo " bg2";
                    }
