...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006d0aa955000000003a9931b0(
...
class phpbbtemplatetwiglexer_000000006d0aa955000000003a9931b0 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5cdea3e8cf69a691540727 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5cdea3e8cf6a0133352034 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5cdea3e8cf683444432597 = array(
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, 'set_environment', array('env' => $env), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;

        return $this->valueHolder5cdea3e8cf69a691540727->set_environment($env);
    }
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;

        return $this->valueHolder5cdea3e8cf69a691540727->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;

        return $this->valueHolder5cdea3e8cf69a691540727->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 = $initializer;
    }
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, '__get', array('name' => $name), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;

        if (isset(self::$publicProperties5cdea3e8cf683444432597[$name])) {
            return $this->valueHolder5cdea3e8cf69a691540727->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5cdea3e8cf69a691540727;
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, '__isset', array('name' => $name), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, '__unset', array('name' => $name), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;
    ...
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, '__clone', array(), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;

        $this->valueHolder5cdea3e8cf69a691540727 = clone $this->valueHolder5cdea3e8cf69a691540727;
    }

    public function __sleep()
    {
        $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, '__sleep', array(), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;

        return array('valueHolder5cdea3e8cf69a691540727');
    }
    ...
    {
        return $this->initializer5cdea3e8cf6a0133352034;
    }
    ...
    {
        return $this->initializer5cdea3e8cf6a0133352034 && ($this->initializer5cdea3e8cf6a0133352034->__invoke($valueHolder5cdea3e8cf69a691540727, $this, 'initializeProxy', array(), $this->initializer5cdea3e8cf6a0133352034) || 1) && $this->valueHolder5cdea3e8cf69a691540727 = $valueHolder5cdea3e8cf69a691540727;
    }
    ...
    {
        return null !== $this->valueHolder5cdea3e8cf69a691540727;
    }
    ...
    {
        return $this->valueHolder5cdea3e8cf69a691540727;
    }
