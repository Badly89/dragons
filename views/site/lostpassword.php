...
<div class="site-login">
    ...
    <p>Для восстановления пароля, в обязательном порядке поместите строку </br><span
    ...
    <div class="form-group">
        <div class="">
            <?= Html::submitButton('Восстановить пароль', ['class' => 'btn btn-primary btn-recover', 'name' => 'login-button']) ?>
        </div>
    </div>
    ...
    <br><br>
    <center>
        <h3><span style="color:#ac2925">Не стоит так часто запрашивать восстановление пароля. <br><br>Пожалуйста,
                подождите немного перед новой попыткой</span></h3>
    </center>
    <?php
    }
    ?>
