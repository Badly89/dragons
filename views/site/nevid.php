        ...
        ">
            ...
            <div class="card-body application-body">
                ...
                <div class="dropdown align-self-end">
                    ...
                    <div class="dropdown-menu dropdown-menu-right border-action " aria-labelledby="dropdownNevid">
                        <?php
                   echo Html::beginForm(['/site/nevid'], 'post',['class' => 'px-4 py-3 d-flex flex-column ']);
                        echo Html::dropDownList('Nevid[action]', null, [
                        ...
                        echo Html::hiddenInput('Nevid[z_id]', $zayavka->zId,['class'=>'form-control']);
                        echo Html::textarea('Nevid[comment]', '', ['cols' => '25'],['class'=>'form-control mb-2']);
